  ...
  return (
    <div className="min-h-screen bg-[#050810] text-slate-100">
      ...
      <div className="relative flex min-h-screen">
        {/* Desktop sidebar */}
        <aside className="sticky top-0 hidden h-screen w-64 shrink-0 self-start border-r border-white/10 bg-[#070b13] lg:block">
          <Sidebar activeSection={activeSection} onNavigate={handleNavigate} />
        </aside>
        ...
        <main className="min-w-0 flex-1">
          ...
          <div className="p-4 md:p-6 xl:p-8">
            {/* Hero */}
            <section id="command" className="mb-7 scroll-mt-24">
            ...
            {/* Main command center */}
            <section id="map" className="grid scroll-mt-24 grid-cols-1 gap-5 xl:grid-cols-3">
              ...
              <div id="incidents" className="min-w-0 scroll-mt-24">
                <PriorityQueue
            ...
            {/* AI section */}
            <section id="ai" className="mt-5 scroll-mt-24">
              <AIInsights
                incidents={sortedIncidents}
                simulationStep={simulationStep}
              />
            ...
            <section id="communications" className="mt-5 scroll-mt-24 rounded-2xl border border-white/10 bg-white/[0.025] p-5 backdrop-blur-xl">
              <div className="flex items-center gap-3">
                <div className="rounded-xl bg-cyan-400/10 p-2 text-cyan-400"><Radio size={18} /></div>
                <div>
                  <h2 className="text-sm font-bold text-white">Communications</h2>
                  <p className="mt-1 text-xs text-slate-500">Operational communication channel status and coordination controls.</p>
                </div>
              </div>
              <div className="mt-4 grid gap-3 sm:grid-cols-3">
                <div className="rounded-xl border border-white/10 bg-black/10 p-3"><div className="text-[9px] uppercase tracking-widest text-slate-600">Dispatch Channel</div><div className="mt-1 text-xs font-semibold text-emerald-400">Online</div></div>
                <div className="rounded-xl border border-white/10 bg-black/10 p-3"><div className="text-[9px] uppercase tracking-widest text-slate-600">Emergency Line</div><div className="mt-1 text-xs font-semibold text-emerald-400">Connected</div></div>
                <div className="rounded-xl border border-white/10 bg-black/10 p-3"><div className="text-[9px] uppercase tracking-widest text-slate-600">Field Teams</div><div className="mt-1 text-xs font-semibold text-slate-300">{initialTeams.length} connected</div></div>
              </div>
            </section>

            <section id="settings" className="mt-5 scroll-mt-24 rounded-2xl border border-white/10 bg-white/[0.025] p-5 backdrop-blur-xl">
              <div className="flex items-center gap-3">
                <div className="rounded-xl bg-white/5 p-2 text-slate-300"><Activity size={18} /></div>
                <div>
                  <h2 className="text-sm font-bold text-white">System Settings</h2>
                  <p className="mt-1 text-xs text-slate-500">Current prototype environment and dashboard configuration.</p>
                </div>
              </div>
              <div className="mt-4 flex flex-wrap gap-2 text-[10px] font-semibold text-slate-400">
                <span className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2">Simulation Data</span>
                <span className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2">Live Monitoring</span>
                <span className="rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2">AI Decision Support</span>
              </div>
            </section>
