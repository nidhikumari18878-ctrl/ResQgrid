...
export default function Sidebar({ activeSection = "command", onNavigate }) {
  return (
    <div className="flex h-screen min-h-0 flex-col overflow-y-auto">
      ...
      <div className="flex-1 px-3 py-6">
            ...
            return (
              <button
                ...
                className={`group relative flex w-full items-center gap-3 rounded-xl px-3 py-3 text-left transition-all duration-200 ${
                  (activeSection === item.section || (item.active && !activeSection))
        ...
        <button
          ...
          className={`group flex w-full items-center gap-3 rounded-xl px-3 py-3 transition hover:bg-white/[0.03] hover:text-slate-200 ${activeSection === "communications" ? "bg-cyan-400/[0.08] text-cyan-300" : "text-slate-500"}`}
        >
        ...
        <button
          ...
          className={`group flex w-full items-center gap-3 rounded-xl px-3 py-3 transition hover:bg-white/[0.03] hover:text-slate-200 ${activeSection === "settings" ? "bg-cyan-400/[0.08] text-cyan-300" : "text-slate-500"}`}
        >
